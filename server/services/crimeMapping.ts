...
export default class CrimeMappingService {
  ...
  async getData(): Promise<Array<Location>> {
    return [
      ...
      { latitude: 51.574622, longitude: 0.048643, confidence: 200, direction: 0.080 },
      { latitude: 51.57610341773559, longitude: 0.048391168020475, confidence: 10, direction: -1.234 },
      { latitude: 51.576400900843375, longitude: 0.045439341454295505, confidence: 12, direction: -0.784 },
    ]
  }
}
